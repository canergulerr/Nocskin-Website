...
<title>
    Accessibility | The Ordinary
</title>

<meta name="description" content="DECIEM is committed to accessibility by incorporating features to improve the experience of users with disabilities, including that of vision and hearing.">
...
<link rel="stylesheet" href="../assets/css/global.css">
    ...
    <link rel="stylesheet" href="/on/demandware.static/Sites-deciem-us-Site/-/en_US/v1761278445707/css/accessibility.css">
...
<div class="page js-page" data-action="Page-Show" data-querystring="cid=accessibility" data-country-redirect="">
...
<div role="main" id="maincontent">
    ...
    <!-- dwMarker="content" dwContentID="43f5bf08fed9f6832da3b07d74" -->
    <link rel="stylesheet" href="https://theordinary.com/assets/css/styles.css">
<div class="doc-container">
<a href="/" class="deciem-logo"></a>
<div class="document">
        <article class="content">
            <h1>Accessibility Commitment.</h1>
            <p>Effective Date: February 1, 2021</p>
            <p>DECIEM is dedicated to operating responsibly, and is motivated to build an organization based on uncompromising ethics, integrity, fairness, diversity, and trust. We aspire to foster a culture of respect for people and the environment in order to be a positive influence in every community we serve.</p>
            <p>We are committed to accessibility, and we believe that the entirety of our audience should be able to completely experience and utilize DECIEM’s online content, including websites, mobile sites, and all of our digital offerings. This is an ongoing commitment, and we will continue our efforts to effectively communicate with our community to ensure our online resources are accessible to, and usable by, all persons, including people with disabilities.</p>
            <p>We aim to produce digital content that conforms to accessibility laws and regulations in the countries where we operate. We also implement the most current versions of the World Wide Web Consortium’s (the “W3C”) Web Content Accessibility Guidelines (“WCAG”) 2.0 for Level A and AA success criteria (the “WCAG 2.0”). To accomplish this, we have brought together a diverse and talented team of individuals who are trained in user experience, sustainability, and digital accessibility, and will endeavour to provide the best online (and offline) experience for all of our users.</p>
            <p>As part of our commitment to accessibility, we have incorporated usability features on our sites that improve the experience of persons using assistive technologies (such as screen reader technologies, and keyboard-only users); users with low/impaired vision; users who are deaf or hard of hearing; users with cognitive disabilities; and users who are color blind.</p>
            <p>In Ontario, Canada, there are additional accessibility laws and standards under the Accessibility for Ontarians with Disabilities Act (AODA) to help to reduce and remove barriers for those with disabilities to make Ontario more inclusive for all. Please explore our specific policies as they relate to AODA below:</p>
            <ul>
                <li><a href="https://theordinary.com/en-us/accessibility-cs-policy">Customer Service Policy</a></li>
                <li><a href="https://theordinary.com/en-us/aoda-accessibility-policy">Accessibility Policy</a></li>
                <li><a href="https://theordinary.com/en-us/accessibility-multi-year-plan">Multi-Year Plan</a></li>
                <li><a href="https://theordinary.com/en-us/accessibility-temporary-disruption-protocol">Temporary Disruption Protocol</a></li>
                <li><a href="https://theordinary.com/en-us/accessibility-accomodation-rtw-policy">Accommodation and Return to Work Policy</a></li>
            </ul>

            <p>We welcome your feedback on your experience of our digital platforms and how we may improve them. If you have any accessibility comments or concerns, or if you would like to request any modifications, please let us know by <b><u><a href="contact-us" class="contact-link">contacting our Customer Happiness team</a></u></b> - we are always here to listen and help. :-)</p>
</article>
        </div>
</div>
    <!-- END_dwmarker -->

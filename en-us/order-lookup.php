...
<script defer="" type="text/javascript" src="../assets/js/js_main.js"></script>
    ...
    <script defer="" type="text/javascript" src="/on/demandware.static/Sites-deciem-us-Site/-/en_US/v1761278445707/js/trackOrder.js">
    </script>
...
<title>
    Order Look Up | The Ordinary
</title>

<meta name="description" content="Look left. Look right. Look up your DECIEM Order.">
...
<link rel="stylesheet" href="../assets/css/global.css">
    ...
    <link rel="canonical" href="order-lookup">
...
<div class="page js-page" data-action="Order-Lookup" data-querystring="" data-country-redirect="">
...
<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item ">
                    ...
                    <span class="breadcrumb--current js-last-breadcrumbs">Track order</span>
        ...
        <div class="container account-create account-create--track">
            <div class="account-create__track-form">
	...
	<div class="content-asset"><!-- dwMarker="content" dwContentID="753aff17db2d53f870c0d5b215" -->
...
<script type='text/javascript'>
 window.launchChat = function() {
  if (window.embeddedservice_bootstrap && window.embeddedservice_bootstrap.utilAPI) {
    ...
    alert('Chat not initialized yet. Please try again.');
  }
}
</script>
<p style="margin-left:20px;"> Get quick order updates through our Live Chat <a href="#" onclick="launchChat(); return false;" id="openSalesforceChat" style="text-decoration: underline"> Order Tracking </a>  tool :-) </p>
	</div> <!-- End content-asset -->



                    <form action="/en-us/order-lookup-details" class="trackorder account-create__trackorder" id="js-track-order-form" method="POST" name="trackorder-form" data-sitekey="6Lf9m4IUAAAAACH_L-j4QsMzio6Q3vP5trHwF5py">
    <div class="card-body">
        ...
        <div class="form-group required">
            ...
            <input type="text" required="" class="form-control" data-missing-error="Order number is required." aria-describedby="form-number-error" id="trackorder-form-number" name="trackOrderNumber">
        ...
        <div class="form-group required">
            ...
            <input type="text" required="" class="form-control" id="trackorder-form-email" data-missing-error="Email address is required." data-pattern-mismatch="Please enter a valid e-mail" data-range-error="Must be 50 characters or less." aria-describedby="form-email-error" name="trackOrderEmail" pattern="^[\w.%+-]+@[\w.-]+\.[\w]{2,6}$" maxlength="50">
            <div class="invalid-feedback" id="form-email-error"></div>
        </div>

        <input type="hidden" name="csrf_token" value="9um3vl6SroQrqOsyAN4NTE90pkxArHqDxPVzdB-Ji8lOiv6I7g1Zpdri5TonT-pJTC-s-O1j2FYsBQ82jzin2TV3SoxF04yJCDiF9d1_zCD3izgCm5Ra-sK7w18SOT-ffkwsDnzXmxFe3Xu7pFq9xxN5QTu_YVY95NGEYbzmnHc6Oi7eGuw=">
        <input type="hidden" class="g-recaptcha-response js-recaptcha-response" name="dwfrm_grecaptcha_response" value="" maxlength="2147483647">


        <div class="form-group">
            <button class="btn btn-save btn-block btn-primary js-submit-track-order" type="submit" name="submitBtn" value="submit">
                Check status
            </button>
        </div>
    </div>

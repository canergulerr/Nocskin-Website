...
<div class="page js-page" data-action="Account-PasswordReset" data-querystring="" data-country-redirect="">
...
<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item ">
                    ...
                    <span class="breadcrumb--current js-last-breadcrumbs">Reset Password</span>
    ...
    <div class="container account-create reset-password">
        <div class="account-create__register-account">
            <div class="account-create__profile-infos reset_password-page">
                <div class="account-create__greeting">
                    <h1 class="request-password-title">Reset Password</h1>
                </div>

                <form class="reset-password-form" action="/on/demandware.store/Sites-deciem-us-Site/en_US/Account-PasswordResetDialogForm?mobile=true" method="POST" name="email-form" id="email-form">
    <div class="request-password-body">
        <div class="form-group required">
            <label class="form-control-label" id="reset-password-email-label" for="reset-password-email">
                Email
            </label>
            <input required="" id="reset-password-email" type="email" class="form-control" name="loginEmail" max-length="50" data-missing-error="Email address is required." data-pattern-mismatch="Please enter a valid e-mail" data-range-error="Must be 50 characters or less." pattern="^[\w.%+\-]+@[\w.\-]+\.[\w]{2,6}$">
            <div class="invalid-feedback"></div>
        </div>
    </div>
    <div class="send-email-btn">
        <button type="submit" id="submitEmailButton" class="btn btn-save btn-primary btn-block">
            Reset Password
        </button>
    </div>
</form>

...
<title>
    Check Gift Card Balance | The Ordinary
</title>
...
<div class="page js-page" data-action="GiveX-ShowGiftCardBalance" data-querystring="" data-country-redirect="">
...
<div role="main" id="maincontent">
    ...
    <div class="giftcard-balance">
        ...
        <div class="wrapper">
            ...
            <div class="links">
                <a class="link" href="gift-card-100570">
                    Buy a gift card
                </a>
                <a class="link" href="faq#giftcards">
                    FAQ
                </a>
            </div>

            <div id="giftcard-balance-container-wrapper">
                <form class="giftCardBalanceCheckForm" id="giftCardBalanceCheckForm" method="POST" action="/on/demandware.store/Sites-deciem-us-Site/en_US/GiveX-CheckGiftCardBalance" name="giftCardBalanceCheckForm" data-sitekey="6Lf9m4IUAAAAACH_L-j4QsMzio6Q3vP5trHwF5py">

                    <h6 class="heading">Check gift card balance</h6>

                    <p class="content">
                        Enter your gift card number and pin to check your balance.
                    </p>

                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label" for="giftcardNumber">Enter gift card number</label>
                                <input type="text" autofocus="" class="form-control" id="giftcardNumber" name="giftcardNumber" data-range-error="The gift card number needs to be 21 characters." data-missing-error="Gift card number is required." data-pattern-mismatch="Please enter a valid gift card number" name="dwfrm_giftCardBalanceCheck_giftcardNumber" required="" aria-required="true" value="" maxlength="21" minlength="21" pattern="^\d*[.]?\d*$">
                                <div class="invalid-feedback" id="giftcardNumber-error">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label" for="giftcardPin">PIN</label>
                                <input type="text" autofocus="" class="form-control" id="giftcardPin" name="giftcardPin" data-range-error="The pin needs to be 4 characters." data-missing-error="PIN is required." name="dwfrm_giftCardBalanceCheck_giftcardPin" required="" aria-required="true" value="" maxlength="4" minlength="4">
                                <div class="invalid-feedback" id="giftcardPin-error">
                                </div>
                            </div>
                        </div>
                    </div>

                    <div id="chkBalErr" class="check-balance-error d-none">Please enter a valid gift card number.</div>

                    <input type="hidden" name="csrf_token" value="RZFdzEdTtGBGRgsTY9IXSShoLM7KLkrX5OdN_gX15PJOMINStVlo-TIYYEA5plaFiZLabWDum_T_20uaAvDXudUJaSbX1W1Ksf-426E6Tfi9Tx5ESnYqmpUVPsot2ps0uzavnedrIYpddnAJw48KXd4s05mYgedEcLWKjZosQWO5jqQFbHc=">
                    <input type="hidden" class="g-recaptcha-response js-recaptcha-response" name="dwfrm_giftCardBalanceCheck_grecaptcha_response" value="" maxlength="2147483647">
            ...
            <img alt="A pink piggy bank" src="/on/demandware.static/Sites-deciem-us-Site/-/default/dwd3c8aab8/images/deciem/pig.jpg" class="background-img">
        </div>

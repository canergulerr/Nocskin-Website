...
<script defer="" type="text/javascript" src="../assets/js/js_main.js"></script>
    ...
    <script defer="" type="text/javascript" src="/on/demandware.static/Sites-deciem-us-Site/-/en_US/v1761278445707/js/modalVideo.js">
    </script>
...
<title>
    DECIEM - About Us | The Ordinary
</title>

<meta name="description" content="We're a humble and happy umbrella of good beauty brands. Explore our brands like The Ordinary, Hylamide, NIOD and more.">
<meta name="keywords" content="deciem the abnomaly beauty company, deciem company history, about deciem, what is deciem">
...
<link rel="stylesheet" href="../assets/css/global.css">
    ...
    <link rel="stylesheet" href="/on/demandware.static/Sites-deciem-us-Site/-/en_US/v1761278445707/css/aboutUs.css">
    ...
    <link rel="canonical" href="deciem-about">
...
<div class="page js-page" data-action="Page-Show" data-querystring="cid=deciem-about" data-country-redirect="">
...
<div role="main" id="maincontent">
    ...
    <!-- dwMarker="content" dwContentID="e66de0a44407346f71793c0c34" -->
    <section class="about-us">
	<div class="deciem-logo row d-sm-none d-md-block">
		<div class="col">
            <a href="/" class="logo logo__deciem">
	...
	<div class="container-wrapper head-section">
		<div class="row">
			<div class="col-md-5 col-left">
				<div class="head-section__content">
					<h1 class="big-title">WE ARE ABNORMAL.
						<br>NO, SERIOUSLY. WE ARE REALLY NOT KIDDING.</h1> <a href="#" class="link-with-line js-video-cta" data-toggle="modal" data-target="#js-video-fs-modal" data-src="https://www.youtube.com/embed/rj_FuyaGRGA">CLICK HERE TO<br>WATCH WHY</a>
                    </div>
                    <div class="head-section__img-cropped">
                      <img src="https://theordinary.com/on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dwb45a1d84/about-us/bkg-cropped.png" alt="cropped-background">
                    </div>
                  </div>
                  <div class="col-md-5 col-lg-4 offset-md-1 col-right">
                    <div class="head-section__lemon-guy">
                      <img src="https://theordinary.com/on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dw55ca642d/about-us/umbrella-stop-motion.gif" alt="lemon-guy">
                    </div>
              ...
              <div class="container-wrapper egghover-section">
                <div class="arrow-line-mobile"></div>
                <div class="row">
                  <div class="egghover-section__content col-md-5 col-lg-4 offset-md-1">
                    <div class="big-a">
                      <div class="letter">A</div>
                      <div class="egg">
                        <img src="https://theordinary.com/on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dw53b14bf4/about-us/egg.png" alt="Egg">
                      </div>
                    </div>
                    <div class="content content-light">
                      <p>
	...
	<div class="container-wrapper large-vid-section">
		<div class="row">
			<div class="large-vid-wrapper video-wrapper video-wrapper__team">
				<div class="js-yt-video-bkg-loop background_yt-video" data-yt-id="ckgQegdJF7k">
					<div class="player-wrapper"></div>
				</div>
			</div>
			<div class="col-md-7 col-lg-6 offset-md-5 offset-lg-6">
				<div class="wrapper-white">
					<div class="content-light">
						<p>Everything we do is of exceptional quality. Today, quality is no longer defined by merely price points or distribution channels. Quality today means being authentic, being different, being functional, being beautiful and being sensibly priced, even to the wealthy. And we respect these principles. We choose to serve the educated, the curious and the intelligent who appreciate our dedication to this very genuine definition of quality.</p>
						<p>Follow us on <a href="https://www.instagram.com/deciem/" target="_blank">Instagram</a>, <a href="https://www.linkedin.com/company/deciem/" target="_blank">LinkedIn</a>, <a href="https://www.tiktok.com/@deciem" target="_blank">Tik Tok</a>, <a href="../deciem" target="_blank">YouTube</a> and <a href="https://www.facebook.com/deciem/" target="_blank">Facebook</a>. We'll share good things.</p>
					</div>
				</div>
			</div>
		</div>
	</div>
	<div class="container-wrapper last-vid-section">
		<div class="row">
			<div class="third-vid col-md-5 col-lg-4 offset-md-1">
				<div class="video-wrapper video-wrapper__people">
					<div class="js-yt-video-bkg-loop background_yt-video" data-yt-id="F9m-KqdDaTw">
						<div class="player-wrapper"></div>
					</div>
				</div>
			</div>
			<div class="arrow-path">
				<img src="https://theordinary.com/on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dw3fefc32a/about-us/arrow-path.svg" alt="arrow-line">
			</div>
			<div class="col-md-5 col-lg-6 offset-md-1">
				<div class="links">
					<h2 class="big-title">WE ARE ALSO
						<br>GOOD PEOPLE.</h2> <a href="#" class="link-with-line js-video-cta" data-toggle="modal" data-target="#js-video-fs-modal" data-src="https://www.youtube.com/embed/ESotD1VvMq8">CLICK HERE TO<br>WATCH WHY</a>
                    </div>
                    <div class="links">
                      <h2 class="big-title">AND WE LIKE<br>GOOD PEOPLE.</h2>
                      <a href="#" class="link-with-line js-video-cta" data-toggle="modal" data-target="#js-video-fs-modal" data-src="https://www.youtube.com/embed/gSFobZqfPxA">CLICK HERE TO<br>WATCH WHY</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="modal fade" id="js-video-fs-modal" tabindex="-1" role="dialog" z="" aria-labelledby="full-screen-video-modal" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="video">
                  <div class="modal-content modal-video">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                      <iframe class="embed-responsive-item" src="" id="js-embed-video" width="560" height="315" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                    </div>
                  </div>
                </div>
              </div>

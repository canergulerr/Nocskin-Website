...
<div class="page js-page" data-action="Cart-Show" data-querystring="" data-country-redirect="">
...
<div class="cart_empty_wrap cart_empty_page">
    <div class="cart_empty_wrap-title">
    I'm empty :-( Please add products.
</div>



    <div class="cart_empty_wrap-btn">
    ...
    <div class="cart_empty_wrap-btn mb-0">
        <a href="../index.php" class="btn btn-outline-primary btn-block continue-shopping">Continue shopping</a>
    </div>


    <div class="cart_empty_brands">
        <div class="cart_empty_brands">
	<div class="brand-circles d-flex">
			<div class="item ordinary-circle">
					<a href="../index.php">
						<img alt="brand theordinary" src="../on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dwc5a74160/cart/theordinary-circle.svg">
					</a>
			</div>
			<div class="item niod-circle">
					<a href="../en-us-1">
						<img alt="brand niod" src="../on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dwd238541c/cart/niod-circle.svg">
					</a>
			</div>
			<div class="item loopha-circle">
					<a href="../en-us-2">
						<img alt="brand loopha" src="../on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dw6e8dfb69/cart/loopha-circle.svg">
					</a>
			</div>
			<div class="item deciem-circle">
					<a href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Home-Deciem">
						<img alt="brand deciem" src="../on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dw5a126fe0/cart/deciem-circle.svg">
					</a>
			</div>
	</div>
</div>

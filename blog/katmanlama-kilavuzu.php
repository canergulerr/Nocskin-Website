...
include dirname(__DIR__) . '/admin/includes/db.php';

// Fetch Post Data
$stmt = $pdo->prepare("SELECT * FROM blog_posts WHERE slug = 'katmanlama-kilavuzu' AND status = 1");
$stmt->execute();
$post = $stmt->fetch();
...
<head>
    ...
    <title>
        Layering Guide | The Ordinary
    </title>

    <meta name="description"
        content="Discover the essentials of skincare layering tailored to your skin type with The Ordinary. Learn our 3-step regimen for optimal skin health.">
    <meta name="keywords" content="Layering skincare products">
    ...
    <link rel="canonical" href="skincare-layering-guide">
...
<body data-brand="theordinary">
    ...
    <div class="page js-page" data-action="Page-Show" data-querystring="cid=skincare-layering-guide"
        ...
        <div role="main" id="maincontent">
            ...
            <!-- dwMarker="content" dwContentID="7b5f5686a73c1f0edbc18ac40f" -->
            <div class="ampliance_layout layout2">
                <div class="inner">
                    <div class="amp_partial content-image">
                        <picture>
                            <source media="(min-width: 1440px)"
                                data-srcset="https://cdn.media.amplience.net/i/deciem/Layering-Guide-Blog_Image-1?fmt=auto&$poi$&sm=aspect&w=1920&aspect=342:97 1x, https://cdn.media.amplience.net/i/deciem/Layering-Guide-Blog_Image-1?fmt=auto&$poi$&sm=aspect&w=3840&aspect=342:97 2x">
                            <source media="(min-width: 1025px)"
                                data-srcset="https://cdn.media.amplience.net/i/deciem/Layering-Guide-Blog_Image-1?fmt=auto&$poi$&sm=aspect&w=1366&aspect=342:97 1x, https://cdn.media.amplience.net/i/deciem/Layering-Guide-Blog_Image-1?fmt=auto&$poi$&sm=aspect&w=2732&aspect=342:97 2x">
                            <source media="(min-width: 767px)"
                                data-srcset="https://cdn.media.amplience.net/i/deciem/Layering-Guide-Blog_Image-1?fmt=auto&$poi$&sm=aspect&w=768&aspect=32:23 1x, https://cdn.media.amplience.net/i/deciem/Layering-Guide-Blog_Image-1?fmt=auto&$poi$&sm=aspect&w=1536&aspect=32:23 2x">
                            <source
                                data-srcset="https://cdn.media.amplience.net/i/deciem/Layering-Guide-Blog_Image-1?fmt=auto&$poi$&sm=aspect&w=750&aspect=32:23">
                            <img class="lazy" alt="The Ordinary dropper with skincare serum on a white background"
                                itemprop="image"
            ...
            <div class="ampliance_layout layout1">
                <div class="d-md-flex flex-wrap inner">
                    ...
                    <div class="col-12 col-lg-5 left-col">
                        <h1 class="title-wrap">
                            <span class="title-text"><?= s('header_title') ?></span>
                            <span class="title-text"><?= s('header_subtitle') ?></span>
                        </h1>
                    </div>
                            ...
                            <div class="amp_partial text-block">
                                <p>
                                    ...
                                    <?php if (s('header_image')): ?>
                                        <img src="<?= s('header_image') ?>" width="75px" height="75px">
                                    <?php endif; ?>
                                </p>
                            </div>
            ...
            <?php
            // Loop through 6 fixed sections
            for ($i = 1; $i <= 6; $i++):
                $title = s("section_{$i}_title");
                $content = s("section_{$i}_content");
                $image1 = s("section_{$i}_image_1");
                $image2 = s("section_{$i}_image_2");

                // Only show if title or content exists to avoid empty blocks
                if ($title || $content):
                    ?>
                    <div class="ampliance_layout layout4">
                        <div class="d-flex flex-wrap flex-column">
                            ...
                            <h1 class="title-block">
                                <span class="title-text"><?= htmlspecialchars($title) ?></span>
                            </h1>
                            ...
                            <div class="d-flex flex-wrap flex-column flex-xl-row justify-content-xl-between">
                                ...
                                <div class="image-block-1 d-none d-xl-block image-block">
                                    <?php if (!empty($image1)): ?>
                                        <div class="amp_partial content-image">
                                            <img class="lazy" src="<?= $image1 ?>" alt="<?= htmlspecialchars($title) ?>">
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="image-block-2 d-flex justify-content-end align-items-xl-end">
                                    <?php if (!empty($image2)): ?>
                                        <div class="amp_partial content-image">
                                            <img class="lazy" src="<?= $image2 ?>" alt="<?= htmlspecialchars($title) ?>">
                                        </div>
                                    <?php endif; ?>
                                </div>

...
$stmt = $pdo->prepare("SELECT * FROM blog_posts WHERE slug = 'malzeme-sozlugu' AND status = 1");
$stmt->execute();
$post = $stmt->fetch();

if (!$post) {
    // Fallback or error if not found, though migration should ensure it exists
    $sections = [];
} else {
...
function render_ingredients_carousel($key, $title)
{
    $items = get_list($key);
    // If no items, we might still want to show the header if explicitly requested, but usually hide if empty
    if (empty($items))
        return;
    ?>
    <div class="ampliance_layout layout6 Carousel">
        <div class="amp_partial">
            <h1 class="title-text"><?= htmlspecialchars($title) ?></h1>
        </div>
        <div class="subtitle">
            <p></p>
        </div>
        <div class="swiper amp_carousel event-carousel" data-config="amplienceEventCarousel">
                    ...
                    <div class="swiper-slide">
                        <div class="event-image">
                            <a href="<?= htmlspecialchars($link) ?>">
                                <img class="lazy" alt="<?= htmlspecialchars($titleItem) ?>"
                        ...
                        <div class="event-name">
                            <span><?= htmlspecialchars($titleItem) ?></span>
                        </div>
                        <div class="amp_partial shop-cta">
                            <a class="shop-arrow-link icon-arrow" href="<?= htmlspecialchars($link) ?>">Daha Fazla Bilgi
                                Edin</a>
                        </div>
                    </div>
                <?php endforeach; ?>
        ...
        <div class="custom-scrollbar" style="--scrollbar-width: 14.2857%" data-slides="7"></div>
    </div>
    <?php
}
?>
...
<head>
    ...
    <script defer="" type="text/javascript"
        src="../assets/js/vendors.js"></script>
    <script defer="" type="text/javascript"
        src="../assets/js/js_main.js"></script>
    ...
    <meta name="description"
        content="Explore The Ordinary&rsquo;s ingredient glossary and uncover the technologies behind our science-led formulas for healthier, radiant skin.">
    ...
    <link rel="stylesheet"
        href="../assets/css/icons-font.css">
    ...
    <link rel="canonical" href="ingredient-glossary">
...
<body data-brand="theordinary">
    ...
    <div class="page js-page" data-action="Page-Show" data-querystring="cid=ingredient-glossary"
        ...
        <div role="main" id="maincontent">
            ...
            <!-- dwMarker="content" dwContentID="c377703e051fe8d907ec73bbb4" -->
                ...
                <div class="inner">
                    <div class="amp_partial content-image">
                        <picture>
                            ...
                            <img class="lazy" alt="Ingredient Glossary Header" itemprop="image"
                                data-src="<?= s('header_image') ?>"
            ...
            <div class="ampliance_layout layout4">
                <div class="d-flex flex-wrap flex-column">
                    ...
                    <h1 class="title-block">
                        <span class="title-text"><?= s('page_title') ?></span>
                    </h1>
            ...
            <?php render_ingredients_carousel('ingredients_a_f', 'İçindekiler (A-F)'); ?>
            ...
            <?php render_ingredients_carousel('ingredients_g_l', 'İçindekiler (G-L)'); ?>
            ...
            <?php render_ingredients_carousel('ingredients_m_r', 'İçindekiler (M-R)'); ?>
            ...
            <?php render_ingredients_carousel('ingredients_s_z', 'İçindekiler (S-Z)'); ?>
...
<![endif]-->
    ...
    <script type="text/javascript"
        src="../assets/js/dwanalytics-22.2.js"
        async="async" onload="trackPage()"></script>
    <!-- Demandware Active Data (body_end-active_data.js) -->
    <script src="../assets/js/dwac-21.7.js"

...
$slug = 'yaslanma-karsiti';
$stmt = $pdo->prepare("SELECT * FROM categories WHERE slug = ?");
$stmt->execute([$slug]);
$category = $stmt->fetch(PDO::FETCH_ASSOC);

if (!$category) {
    $category = ['id' => 8, 'slug' => $slug];
}
...
// Fetch Page Sections
$pageIdentifier = 'yaslanma-karsiti';
...
<head>
    ...
    <title>
        Yaşlanma Karşıtı & Sıkılaştırma | Noc
    </title>
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Yaşlanma Karşıtı & Sıkılaştırma</span>
            ...
            <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'ciltbakim-yaslanma-karsiti'); ?>
                ...
                <div class="row product-grid js-product-grid" itemtype="http://schema.org/SomeProducts"
                    ...
                    $contentBlocks = getPageContentBlocks($pdo, 'yaslanma-karsiti');

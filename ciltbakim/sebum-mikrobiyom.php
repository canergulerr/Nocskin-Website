...
$categorySlug = 'sebum-mikrobiyom-destekleyiciler';
$fallbackCatId = 31;
...
<head>
    ...
    <title>
        Sebum & Mikrobiyom Dengeleyici Bileşenler | Noc
    </title>

    <meta name="description"
        content="The Ordinary Prep: gentle cleansers, toners &amp; essences. Prime your skin for treatments and build your ideal skincare routine for a fresh, prepared base.">
...
<body data-brand="theordinary">
    ...
    <div class="page js-page" data-action="Search-Show" data-querystring="cgid=theordinary-shopbystep-step1"
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block mt-0 pt-0"
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item icon-right_chevron">
                        ...
                        <a href="../../../the-ordinary/skincare/shop-by-step">Malzemelere Göre Alışveriş Yapın</a>
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Sebum & Mikrobiyom Dengeleyici Bileşenler</span>
            ...
            <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'ciltbakim-sebum-mikrobiyom'); ?>
                                        ...
                                        <ul class="sort-order" aria-label="Sort By">
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link top-sellers  p-4 p-lg-0" data-id="top-sellers"
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-shopbystep-step1&prefn1=availableCountries&prefv1=US&srule=top-sellers&start=0&sz=7">
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link best-matches  p-4 p-lg-0"
                                                    ...
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-shopbystep-step1&prefn1=availableCountries&prefv1=US&srule=best-matches&start=0&sz=7">
                                                    <i class="sort-order-link-icon"></i>
                                                    Best Matches
                                                </a>
                                            </li>
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link price-low-to-high  p-4 p-lg-0"
                                                    ...
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-shopbystep-step1&prefn1=availableCountries&prefv1=US&srule=price-low-to-high&start=0&sz=7">
                                                    <i class="sort-order-link-icon"></i>
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link price-high-to-low  p-4 p-lg-0"
                                                    ...
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-shopbystep-step1&prefn1=availableCountries&prefv1=US&srule=price-high-to-low&start=0&sz=7">
                                                    <i class="sort-order-link-icon"></i>
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link rating  p-4 p-lg-0" data-id="rating"
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-shopbystep-step1&prefn1=availableCountries&prefv1=US&srule=rating&start=0&sz=7">
                                                    <i class="sort-order-link-icon"></i>
                                                    Rating
                                                </a>
                                            </li>
                                            ...
                                            <div class="refinement-group-body category-refinement-group-body collapse "
                                                ...
                                                <ul class="values content list-group ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=activeIngredient&amp;prefv1=Direct%20Acids&amp;prefn2=availableCountries&amp;prefv2=US&amp;productRefineBar=true"
        ...
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=activeIngredient&amp;prefv1=Hydrators&amp;prefn2=availableCountries&amp;prefv2=US&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=activeIngredient&amp;prefv1=Squalane&amp;prefn2=availableCountries&amp;prefv2=US&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                        ...
                                        <div class="refinement refinement-preferences plp-search-refinement"
                                            data-id="preferences">
                                            <div class="refinement-group-header">
                                                <a class="title d-lg-none" data-toggle="collapse" href="#preferences"
                                                    role="button" aria-expanded="false" aria-controls="preferences">
                                            ...
                                            <div class="refinement-group-body category-refinement-group-body collapse "
                                                ...
                                                <ul class="values content list-group ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=alcoholFree&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=crueltyFree&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=glutenFree&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=oilFree&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=siliconeFree&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=vegan&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                        ...
                                        <div class="refinement refinement-concern plp-search-refinement"
                                            ...
                                            <div class="refinement-group-body category-refinement-group-body collapse "
                                                ...
                                                <ul class="values content list-group ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Uneven%20Skin%20Tone&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Textural%20Irregularities&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Dryness&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Dullness&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Cleansing&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Barrier%20Support&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                        ...
                                        <div class="refinement refinement-format plp-search-refinement"
                                            ...
                                            <div class="refinement-group-body category-refinement-group-body collapse "
                                                ...
                                                <ul class="values content list-group ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=format&amp;prefv2=Cream&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=format&amp;prefv2=Gel&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=format&amp;prefv2=Liquid&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=format&amp;prefv2=Balm&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
                                        ...
                                        <div class="refinement refinement-regimen-step plp-search-refinement"
                                            ...
                                            <div class="refinement-group-header">
                                                <a class="title d-lg-none" data-toggle="collapse" href="#regimen-step"
                                                    role="button" aria-expanded="false" aria-controls="regimen-step">
                                            ...
                                            <div class="refinement-group-body category-refinement-group-body collapse "
                                                ...
                                                <ul class="values content list-group ">
                                                    ...
                                                    <li class="list-group-item p-0 ">
                                                        <button
                                                            data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-shopbystep-step1&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=stepType&amp;prefv2=Prep&amp;productRefineBar=true"
                                                            class="px-lg-0 filters_item
        ">
...
and then makes a call to render the configured template with the returned recommended products: ================= -->
                            ...
                            <div class="col-12 p-0 tab-pane content-tab-pane">
                                <div class="content-grid js-content-grid" id="content-search-results-pane"
                                    ...
                                    <div class="content-list-module">
                                        <div class="content-list-header">
                                            <div class="header__title"><br>
                                                <h2>Noc. Kütüphanesi'ndeki Temel Bilgilere Dönüş Kaynaklarımızdan
                                                    Bazılarını İnceleyin</h2>
                                            </div>
                                                ...
                                                <div class="secondary-item">
                                                    ...
                                                    <div class="content-copy">
                                                        <p class="content-copy_subtitle">
                                                            Cilt Bakımı Eğitimi </p>
                                                        <h2 class="content-copy_title"> <a
                                                                href="en-us/blog/skincare-toners" target="_blank">Cilt
                                                                Toniği Nedir?</a> </h2>
                                                    </div>
                                                </div>
                                            </div>
...
<![endif]-->
        ...
        <script defer="defer" src="<?= BASE_URL ?>/assets/js/sms_aff_clicktrack-deciem.js"
            type="text/javascript"></script><!-- End ShopMy -->

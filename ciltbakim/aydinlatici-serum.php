...
$slug = 'aydinlatici-serum';
$stmt = $pdo->prepare("SELECT * FROM categories WHERE slug = ?");
$stmt->execute([$slug]);
$category = $stmt->fetch(PDO::FETCH_ASSOC);

if (!$category) {
    $category = ['id' => 23, 'slug' => $slug];
}
...
// Fetch Page Sections
$pageIdentifier = 'aydinlatici-serum';
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Aydınlatıcı Serum</span>
            ...
            <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'skincare-aydinlatici-serum'); ?>
                ...
                <div class="row product-grid js-product-grid" itemtype="http://schema.org/SomeProducts"
                    ...
                    $contentBlocks = getPageContentBlocks($pdo, 'aydinlatici-serum');

...
$slug = 'aydinlatici-ton-esitleyici-aktifler';
$stmt = $pdo->prepare("SELECT * FROM categories WHERE slug = ?");
$stmt->execute([$slug]);
$category = $stmt->fetch(PDO::FETCH_ASSOC);

if (!$category) {
    $category = ['id' => 28, 'slug' => $slug];
}
...
// Fetch Page Sections
$pageIdentifier = 'aydinlatici-ton-esitleyici-aktifler';
...
<head>
    ...
    <title>
        Aydınlatıcı & Ton Eşitleyici Bileşenler | Noc
    </title>
...
<body data-brand="theordinary">
    ...
    <div class="page js-page" data-action="Search-Show" data-querystring="cgid=theordinary-facialcleansers"
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item icon-right_chevron">
                        ...
                        <a href="<?= BASE_URL ?>/the-ordinary/skincare/shop-by-step">Malzemelere Göre Alışveriş Yapın</a>
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Aydınlatıcı & Ton Eşitleyici Bileşenler</span>
            ...
            <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'ciltbakim-aydinlatici-ton-esitleyici'); ?>
        ...
        ">
                    ...
                    $contentBlocks = getPageContentBlocks($pdo, 'aydinlatici-ton-esitleyici');

...
$slug = 'cilt-canlandirici-tonik';
$stmt = $pdo->prepare("SELECT * FROM categories WHERE slug = ?");
$stmt->execute([$slug]);
$category = $stmt->fetch(PDO::FETCH_ASSOC);

if (!$category) {
    $category = ['id' => 26, 'slug' => $slug];
}
...
// Fetch Page Sections
$pageIdentifier = 'cilt-canlandirici-tonik';
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Cilt Canlandırıcı Tonik</span>
            ...
            <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'skincare-cilt-canlandirici-tonik'); ?>
                            ...
                            <div class="refinements plp-search-refinements">
                                ...
                                <div class="refinement refinement-product-type plp-search-refinement"
                                    ...
                                    <div class="refinement-group-header">
                                        <a class="title d-lg-none" data-toggle="collapse" href="#product-type"
                                            role="button" aria-expanded="true" aria-controls="product-type">
                                ...
                                <div class="refinement refinement-active-ingredient plp-search-refinement"
                                    ...
                                    <div class="refinement-group-header">
                                        <a class="title d-lg-none" data-toggle="collapse" href="#active-ingredient"
                                            role="button" aria-expanded="false" aria-controls="active-ingredient">
                                ...
                                <div class="refinement refinement-concern plp-search-refinement" data-id="concern">
                                    <div class="refinement-group-header">
                                        <a class="title d-lg-none" data-toggle="collapse" href="#concern" role="button"
                                            aria-expanded="false" aria-controls="concern">
                                            <span>Concern</span>
                                        </a>
                                ...
                                <div class="refinement refinement-format plp-search-refinement" data-id="format">
                                    <div class="refinement-group-header">
                                        <a class="title d-lg-none" data-toggle="collapse" href="#format" role="button"
                ...
                <div class="row product-grid js-product-grid" itemtype="http://schema.org/SomeProducts"
                    ...
                    $contentBlocks = getPageContentBlocks($pdo, 'cilt-canlandirici-tonik');
                                ...
                                <div class="primary-item">
                                    ...
                                    <div class="content-copy">
                                        ...
                                        <h2 class="content-copy_title"> <a
                                                href="en-us/blog/mastering-skincare-routine-guide" target="_blank">Bir
                                                Rejim Nasıl Oluşturulur</a> </h2>
                                    </div>
                                </div>

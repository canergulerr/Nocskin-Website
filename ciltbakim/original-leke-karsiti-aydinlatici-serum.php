<?php require_once 'C:/xampp/htdocs/admin/includes/db.php';
require_once 'C:/xampp/htdocs/includes/banner_helper.php';
require_once 'C:/xampp/htdocs/includes/page_content_helper.php'; ?>
...
<head>
    ...
    <title>
        Leke Karşıtı & Aydınlatıcı & Gözenek Sıkılaştırıcı Serum | Noc
    </title>

    <meta name="description"
        content="The Ordinary's exfoliating toner solutions are available for a variety of skin types and concerns. Order today and improve your skin's radiance.">
    <meta name="keywords" content="the ordinary toner, glycolic acid toner, skin toner">
    ...
    <link rel="canonical" href="toners">
...
<body data-brand="theordinary">
    ...
    <div class="page js-page" data-action="Search-Show" data-querystring="cgid=theordinary-toners"
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Leke Karşıtı & Aydınlatıcı & Gözenek
                            Sıkılaştırıcı Serum</span>
           ...
           <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'skincare-leke-karsiti-aydinlatici-serum'); ?>
                                        ...
                                        <ul class="sort-order" aria-label="Sort By">
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link top-sellers  p-4 p-lg-0" data-id="top-sellers"
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&prefn1=availableCountries&prefv1=US&srule=top-sellers&start=0&sz=4">
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link best-matches  p-4 p-lg-0"
                                                    ...
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&prefn1=availableCountries&prefv1=US&srule=best-matches&start=0&sz=4">
                                                    <i class="sort-order-link-icon"></i>
                                                    Best Matches
                                                </a>
                                            </li>
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link price-low-to-high  p-4 p-lg-0"
                                                    ...
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&prefn1=availableCountries&prefv1=US&srule=price-low-to-high&start=0&sz=4">
                                                    <i class="sort-order-link-icon"></i>
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link price-high-to-low  p-4 p-lg-0"
                                                    ...
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&prefn1=availableCountries&prefv1=US&srule=price-high-to-low&start=0&sz=4">
                                                    <i class="sort-order-link-icon"></i>
                                            ...
                                            <li class="sort-order-list">
                                                <a class="sort-order-link rating  p-4 p-lg-0" data-id="rating"
                                                    href="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&prefn1=availableCountries&prefv1=US&srule=rating&start=0&sz=4">
                                                    <i class="sort-order-link-icon"></i>
                                                    Rating
                                                </a>
                                            </li>
                                                ...
                                                <div class="refinement-group-body category-refinement-group-body collapse  active show"
                                                    ...
                                                    <ul class="values content list-group ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=productType&amp;prefv2=Toners%20%26%20Essences&amp;productRefineBar=true"
        ...
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=productType&amp;prefv2=Sets%20%26%20Collections&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                            ...
                                            <div class="refinement refinement-active-ingredient plp-search-refinement"
                                                ...
                                                <div class="refinement-group-body category-refinement-group-body collapse "
                                                    ...
                                                    <ul class="values content list-group ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=activeIngredient&amp;prefv1=Direct%20Acids&amp;prefn2=availableCountries&amp;prefv2=US&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=activeIngredient&amp;prefv1=Squalane&amp;prefn2=availableCountries&amp;prefv2=US&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                            ...
                                            <div class="refinement refinement-preferences plp-search-refinement"
                                                ...
                                                <div class="refinement-group-body category-refinement-group-body collapse "
                                                    ...
                                                    <ul class="values content list-group ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=alcoholFree&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=crueltyFree&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=glutenFree&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=oilFree&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=siliconeFree&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=properties&amp;prefv2=vegan&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                            ...
                                            <div class="refinement refinement-concern plp-search-refinement"
                                                ...
                                                <div class="refinement-group-body category-refinement-group-body collapse "
                                                    ...
                                                    <ul class="values content list-group ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Uneven%20Skin%20Tone&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Textural%20Irregularities&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Dryness&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=skinConcern&amp;prefv2=Dullness&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                            ...
                                            <div class="refinement refinement-format plp-search-refinement"
                                                ...
                                                <div class="refinement-group-body category-refinement-group-body collapse "
                                                    ...
                                                    <ul class="values content list-group ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=format&amp;prefv2=Liquid&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                                            ...
                                            <div class="refinement refinement-regimen-step plp-search-refinement"
                                                ...
                                                <div class="refinement-group-body category-refinement-group-body collapse "
                                                    ...
                                                    <ul class="values content list-group ">
                                                        ...
                                                        <li class="list-group-item p-0 ">
                                                            <button
                                                                data-href="/on/demandware.store/Sites-deciem-us-Site/en_US/Search-ShowAjax?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;prefn2=stepType&amp;prefv2=Prep&amp;productRefineBar=true"
                                                                class="px-lg-0 filters_item
        ">
                            ...
                            <div class="row product-grid js-product-grid" itemtype="http://schema.org/SomeProducts"
                                    ...
                                    (function () {
                                        try {
                                            if (window.CQuotient) {
                                                ...
                                                cq_params.categoryId = 'theordinary-toners';
                                                cq_params.refinements = '[{\"name\":\"availableCountries\",\"value\":\"US\"},{\"name\":\"Category\",\"value\":\"theordinary-toners\"}]';
                                    ...
                                    (function () {
                                        try {
                                            if (dw.ac) {
                                                ...
                                                search_params.refs = '[{\"name\":\"availableCountries\",\"value\":\"US\"},{\"name\":\"Category\",\"value\":\"theordinary-toners\"}]';
                                                search_params.sort = 'top-sellers-collections-suppressed';
                                                search_params.imageUUID = '';
                                                search_params.searchID = '35723d41-2448-47a4-a64a-49858fab2f57';
                                                search_params.locale = 'en_US';
                                                search_params.queryLocale = 'default';
                                                search_params.showProducts = 'true';
                                                dw.ac.applyContext({ category: "theordinary-toners", searchData: search_params });
                                ...
                                <div class="product-grid-item">
                                    <div class="product" data-pid="769915234404" data-available="true">
                                        ...
                                        <div class="product-tile product-detail js-product-tile js-gtm-product-data js-pid-769915234404  "
                                            data-pid="769915234404" data-available="true"
                                            data-gtm-enhanced-ecommerce="{&quot;id&quot;:&quot;769915234404&quot;,&quot;name&quot;:&quot;Multi-Active Delivery Essence&quot;,&quot;brand&quot;:&quot;The Ordinary&quot;,&quot;variant&quot;:&quot;100ml &quot;,&quot;price&quot;:&quot;12.00&quot;,&quot;siteID&quot;:&quot;deciem-us&quot;,&quot;localeID&quot;:&quot;en_US&quot;}">
                                            ...
                                            <div class="tile-container">
                                                ...
                                                <div class="image-container">
                                                    ...
                                                    <a class="wishlistTile js-wishlist-container addProductWishlist"
                                                        ...
                                                        title="Wishlist" data-pid="769915234404">
                                                    ...
                                                    <button
                                                        ...
                                                        data-url="/on/demandware.store/Sites-deciem-us-Site/en_US/Product-ShowQuickView?pid=769915234404"
                                                        data-toggle="modal" data-target="#quickViewModal"
                                                        title="Quick View for Multi-Active Delivery Essence"
                                                ...
                                                <div class="tile-body">
                                                    ...
                                                    <h2 class="pdp-link">
                                                        <a class="link product-link"
                                                            href="../../multi-active-delivery-essence-100706">Multi-Active
                                                            Delivery Essence</a>
                                                    </h2>
                                                ...
                                                <div class="tile-body-footer">
                                                    ...
                                                    <div class="ratings">
                                                        ...
                                                        <div class="bazaar-container">
                                                            <a class="bazaar-link"
                                                                href="../../multi-active-delivery-essence-100706#bazaar-rating"></a>
                                                            <div data-bv-show="inline_rating" data-bv-productid="100706"
                                                                data-bv-redirect-url="/en-us/multi-active-delivery-essence-100706"
                                                        ...
                                                        <div class="size_wrap">
                                                            ...
                                                            <div class="d-block d-md-none">
                                                                <select class="js-attribute-value_link size">
                                                                    ...
                                                                    <option
                                                                        value="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Product-Variation?dwvar_100706_size=&amp;pid=100706&amp;quantity=1">
                                                                        100ml
                                                                    </option>
                                                            ...
                                                            <div class="d-none d-md-block">
                                                                ...
                                                                <div class="attribute-values product_tile-attributes_value product-variation"
                                                                    ...
                                                                    <div class="attribute-value-container ">
                                                                        <button
                                                                            data-url="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Product-Variation?dwvar_100706_size=&amp;pid=100706&amp;quantity=1"
                            ...
                            ">
                                                        ...
                                                        <div class="adding_to_cart-inner">
                                                            ...
                                                            <div class="add_to_cart_footer js-add_to_cart_footer">
                                                                <button
                                                                    ...
                                                                    data-available="true" data-pid="769915234404"
                                ...
                                <div class="product-grid-item">
                                    <div class="product" data-pid="769915233551" data-available="true">
                                        ...
                                        <div class="product-tile product-detail js-product-tile js-gtm-product-data js-pid-769915233551  "
                                            data-pid="769915233551" data-available="true"
                                            data-gtm-enhanced-ecommerce="{&quot;id&quot;:&quot;769915233551&quot;,&quot;name&quot;:&quot;Saccharomyces Ferment 30% Milky Toner&quot;,&quot;brand&quot;:&quot;The Ordinary&quot;,&quot;variant&quot;:&quot;100ml &quot;,&quot;price&quot;:&quot;14.00&quot;,&quot;siteID&quot;:&quot;deciem-us&quot;,&quot;localeID&quot;:&quot;en_US&quot;}">
                                            ...
                                            <div class="tile-container">
                                                ...
                                                <div class="image-container">
                                                    ...
                                                    <div class="plp-award-tag">
                                                        <img src="<?= BASE_URL ?>/on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dw39774d8e/awards/allure-bestofbeauty-award-2024.png"
                                                            title="Allure Best of Beauty Awards 2024"
                                                            alt="Allure Best of Beauty Awards 2024">
                                                    </div>
                                                    ...
                                                    <a class="wishlistTile js-wishlist-container addProductWishlist"
                                                        href="<?= BASE_URL ?>/on/demandware.store/Sites-deciem-us-Site/en_US/Wishlist-AddProduct.json"
                                                        title="Wishlist" data-pid="769915233551">
                                                        <span class="fa-stack fa-lg wishlist-product-heart"
                                                            data-pid="769915233551">
                                                            <i class="fa fa-circle fa-inverse fa-stack-2x"></i>
                                                            <i class="fa icon-heart fa-stack-1x"></i>
                                                        </span>
                                                    </a>
                                                    ...
                                                    <a class="product-link"
                                                        ...
                                                        <picture>
                                                            ...
                                                            <img class="tile-image lazy " itemprop="image"
                                                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAAXNSR0IB2cksfwAAAAlwSFlzAAALEwAACxMBAJqcGAAAAANQTFRF+Pj4c64OKQAAAApJREFUeJxjYAAAAAIAAUivpHEAAAAASUVORK5CYII="
                                                                alt="The Ordinary Saccharomyces Ferment 30% Milky Toner"
                                                    ...
                                                    <button
                                                        class="quickview js-quickview hidden-md-down btn btn-primary btn-block"
                                                        data-url="/on/demandware.store/Sites-deciem-us-Site/en_US/Product-ShowQuickView?pid=769915233551"
                                                        data-toggle="modal" data-target="#quickViewModal"
                                                        title="Quick View for Saccharomyces Ferment 30% Milky Toner"
                                                        aria-label="Quick View for Saccharomyces Ferment 30% Milky Toner">
                                                        <span class="quickview-btn-icon"></span>
                                                ...
                                                <div class="tile-body">
                                                    ...
                                                    <h2 class="pdp-link">
                                                        <a class="link product-link"
                                                            href="../../saccharomyces-ferment-30-milky-toner-100647">Saccharomyces
                                                            Ferment 30% Milky Toner</a>
                                                    </h2>
                                                ...
                                                <div class="tile-body-footer">
                                                    ...
                                                    <div class="ratings">
                                                        ...
                                                        <div class="bazaar-container">
                                                            <a class="bazaar-link"
                                                                href="../../saccharomyces-ferment-30-milky-toner-100647#bazaar-rating"></a>
                                                            <div data-bv-show="inline_rating" data-bv-productid="100647"
                                                                data-bv-redirect-url="/en-us/saccharomyces-ferment-30-milky-toner-100647"
                                                                data-bv-seo="false"></div>
                                                        </div>
                                                        ...
                                                        <div class="size_wrap">
                                                            ...
                                                            <div class="d-block d-md-none">
                                                                <select class="js-attribute-value_link size">
                                                                    ...
                                                                    <option
                                                                        value="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Product-Variation?dwvar_100647_size=&amp;pid=100647&amp;quantity=1">
                                                                        100ml
                                                                    </option>
                                                            ...
                                                            <div class="d-none d-md-block">
                                                                ...
                                                                <div class="attribute-values product_tile-attributes_value product-variation"
                                                                    ...
                                                                    <div class="attribute-value-container ">
                                                                        <button
                                                                            data-url="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Product-Variation?dwvar_100647_size=&amp;pid=100647&amp;quantity=1"
                                                    ...
                                                    <div class="adding_to_cart">
                                                        <div class="adding_to_cart-inner">
                                                            ...
                                                            <div class="add_to_cart_footer js-add_to_cart_footer">
                                                                <button
                                                                    class="btn btn-block js-tile-add-to-cart-btn js-back-in-stock "
                                                                    data-available="true" data-pid="769915233551"
                                                                    data-stock-notification-url="/on/demandware.store/Sites-deciem-us-Site/en_US/StockNotification-Show?pid=769915233551">
                                ...
                                <div class="grid-interrupter-tile" data-category="">
                                    <div class="grid-interrupter-slot-container">
                                        ...
                                        <div class="content-image">
                                            <img src="<?= BASE_URL ?>/on/demandware.static/-/Library-Sites-DeciemSharedLibrary/default/dw7ece4d9c/theordinary/gridbreakers/essence-vs-toner-blog-gridbreaker.jpg"
                                                title="" alt="">
                                        </div>
                                        ...
                                        <div class="content-body">
                                            ...
                                            <div class="content-title">
                                                Esans mı, Tonik mi? Aradaki Farkı Öğrenin
                                            </div>



                                            <div class="content-msg">
                                                Esans ve toniklerin nasıl çalıştığını, faydalarını ve hangisinin cilt
                                                bakım rutininize en uygun olduğunu öğrenin.
                                            </div>
                                            ...
                                            <div class="amp_partial general-cta">
                                                ...
                                                <a class="btn-rounded-primary"
                                                    href="/on/demandware.store/Sites-deciem-us-Site/en_US/Page-Show?cid=essence-vs-toner">Daha
                                                    Fazla Oku</a>
                                            </div>
                                        ...
                                        <div class="product-tile product-detail js-product-tile js-gtm-product-data js-pid-769915234053  "
                                            ...
                                            <div class="tile-container">
                                                ...
                                                <div class="image-container">
                                                    ...
                                                    <a class="product-link"
                                                        href="../../glycolic-acid-7-exfoliating-toner-100418">
                                                        <picture>
                                                            <source media="(min-width: 1024px)"
                                                ...
                                                <div class="tile-body">
                                                    ...
                                                    <h2 class="pdp-link">
                                                        <a class="link product-link"
                                                            href="../../glycolic-acid-7-exfoliating-toner-100418">Glycolic
                                                ...
                                                <div class="tile-body-footer">
                                                    ...
                                                    <div class="ratings">
                                                        ...
                                                        <div class="bazaar-container">
                                                            <a class="bazaar-link"
                                                                href="../../glycolic-acid-7-exfoliating-toner-100418#bazaar-rating"></a>
                    ...
                    selectable">
                            ...
                            ">
                                ...
                                <script type="text/javascript">//<!--
                                    /* <![CDATA[ (viewProduct-active_data.js) */
                                    dw.ac._capture({ id: "100666", type: "searchhit" });
                                    /* ]]> */
                                    // -->
                                </script>
                                ...
                                <div class="product-grid-item">
                                    <div class="product" data-pid="769915234138" data-available="false">





                                        <div class="product-tile product-detail js-product-tile js-gtm-product-data js-pid-769915234138  "
                                            data-pid="769915234138" data-available="false"
                                            data-gtm-enhanced-ecommerce="{&quot;id&quot;:&quot;769915234138&quot;,&quot;name&quot;:&quot;The Glycolic Acid Set&quot;,&quot;brand&quot;:&quot;The Ordinary&quot;,&quot;variant&quot;:&quot;1 set &quot;,&quot;price&quot;:&quot;15.00&quot;,&quot;siteID&quot;:&quot;deciem-us&quot;,&quot;localeID&quot;:&quot;en_US&quot;}">
                                            <!-- dwMarker="product" dwContentID="9ced92bf4932f21dd744ebefba" -->
                                            <div class="tile-container">
                                                ...
                                                <div class="image-container">
                                                    ...
                                                    <a class="wishlistTile js-wishlist-container addProductWishlist"
                                                        href="<?= BASE_URL ?>/on/demandware.store/Sites-deciem-us-Site/en_US/Wishlist-AddProduct.json"
                                                        title="Wishlist" data-pid="769915234138">
                                                        <span class="fa-stack fa-lg wishlist-product-heart"
                                                            data-pid="769915234138">
                                                            <i class="fa fa-circle fa-inverse fa-stack-2x"></i>
                                                            <i class="fa icon-heart fa-stack-1x"></i>
                                                        </span>
                                                    </a>
                                                    ...
                                                    <a class="product-link"
                                                        href="../../the-glycolic-acid-gift-set-100666">
                                                        <picture>
                                                            <source media="(min-width: 1024px)"
                                                                data-srcset="https://theordinary.com/dw/image/v2/BFKJ_PRD/on/demandware.static/-/Sites-deciem-master/default/dw3574f5c8/Images/products/The%20Ordinary/ord-glycolic-acid-gift-set.png?sw=320&amp;sh=320&amp;sm=fit 1x, https://theordinary.com/dw/image/v2/BFKJ_PRD/on/demandware.static/-/Sites-deciem-master/default/dw3574f5c8/Images/products/The%20Ordinary/ord-glycolic-acid-gift-set.png?sw=640&amp;sh=640&amp;sm=fit 2x">
                                                            <source
                                                                data-srcset="https://theordinary.com/dw/image/v2/BFKJ_PRD/on/demandware.static/-/Sites-deciem-master/default/dw3574f5c8/Images/products/The%20Ordinary/ord-glycolic-acid-gift-set.png?sw=220&amp;sh=220&amp;sm=fit 1x, https://theordinary.com/dw/image/v2/BFKJ_PRD/on/demandware.static/-/Sites-deciem-master/default/dw3574f5c8/Images/products/The%20Ordinary/ord-glycolic-acid-gift-set.png?sw=440&amp;sh=440&amp;sm=fit 2x">
                                                            <img class="tile-image lazy " itemprop="image"
                                                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAAXNSR0IB2cksfwAAAAlwSFlzAAALEwAACxMBAJqcGAAAAANQTFRF+Pj4c64OKQAAAApJREFUeJxjYAAAAAIAAUivpHEAAAAASUVORK5CYII="
                                                                alt="The Ordinary The Glycolic Acid Set"
                                                                title="The Glycolic Set ">
                                                        </picture>
                                                    </a>
                                                    ...
                                                    <button
                                                        class="quickview js-quickview hidden-md-down btn btn-primary btn-block"
                                                        data-url="/on/demandware.store/Sites-deciem-us-Site/en_US/Product-ShowQuickView?pid=769915234138"
                                                        data-toggle="modal" data-target="#quickViewModal"
                                                        title="Quick View for The Glycolic Acid Set"
                                                        aria-label="Quick View for The Glycolic Acid Set">
                                                        <span class="quickview-btn-icon"></span>
                                                ...
                                                <div class="tile-body">
                                                    ...
                                                    <h2 class="pdp-link">
                                                        <a class="link product-link"
                                                            href="../../the-glycolic-acid-gift-set-100666">The Glycolic
                                                            Acid Set</a>
                                                    </h2>
                                                ...
                                                <div class="tile-body-footer">
                                                    ...
                                                    <div class="ratings">
                                                        ...
                                                        <div class="bazaar-container">
                                                            <a class="bazaar-link"
                                                                href="../../the-glycolic-acid-gift-set-100666#bazaar-rating"></a>
                                                            <div data-bv-show="inline_rating" data-bv-productid="100666"
                                                                data-bv-redirect-url="/en-us/the-glycolic-acid-gift-set-100666"
                                                                data-bv-seo="false"></div>
                                                        </div>
                                                        ...
                                                        <div class="size_wrap">
                                                            ...
                                                            <div class="d-block d-md-none">
                                                                <select class="js-attribute-value_link size">
                                                                    ...
                                                                    <option
                                                                        value="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Product-Variation?dwvar_100666_size=&amp;pid=100666&amp;quantity=1">
                                                                        1 set
                                                                    </option>
                                                            ...
                                                            <div class="d-none d-md-block">
                                                                ...
                                                                <div class="attribute-values product_tile-attributes_value product-variation"
                                                                    ...
                                                                    <div class="attribute-value-container ">
                                                                        <button
                                                                            data-url="https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Product-Variation?dwvar_100666_size=&amp;pid=100666&amp;quantity=1"
                                                                            data-attr-value="1setNA" class="js-attribute-value_link attribute-value_link item product_tile-attributes_link
                    size
                    selected
                    unselectable">
                            ...
                            ">
                                                    ...
                                                    <div class="adding_to_cart">
                                                        <div class="adding_to_cart-inner">
                                                            ...
                                                            <div class="add_to_cart_footer js-add_to_cart_footer">
                                                                <button
                                                                    class="btn btn-block js-tile-add-to-cart-btn js-back-in-stock btn-outofstock"
                                                                    data-available="false" data-pid="769915234138"
                                                                    data-stock-notification-url="/on/demandware.store/Sites-deciem-us-Site/en_US/StockNotification-Show?pid=769915234138">
                                ...
                                <div class="col-12 grid-footer js-grid-footer"
                                    data-sort-options="{&quot;options&quot;:[{&quot;displayName&quot;:&quot;Bestsellers&quot;,&quot;id&quot;:&quot;top-sellers&quot;,&quot;url&quot;:&quot;https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;srule=top-sellers&amp;start=0&amp;sz=4&quot;},{&quot;displayName&quot;:&quot;Best Matches&quot;,&quot;id&quot;:&quot;best-matches&quot;,&quot;url&quot;:&quot;https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;srule=best-matches&amp;start=0&amp;sz=4&quot;},{&quot;displayName&quot;:&quot;Rank by lowest price&quot;,&quot;id&quot;:&quot;price-low-to-high&quot;,&quot;url&quot;:&quot;https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;srule=price-low-to-high&amp;start=0&amp;sz=4&quot;},{&quot;displayName&quot;:&quot;Rank by highest price&quot;,&quot;id&quot;:&quot;price-high-to-low&quot;,&quot;url&quot;:&quot;https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;srule=price-high-to-low&amp;start=0&amp;sz=4&quot;},{&quot;displayName&quot;:&quot;Rating&quot;,&quot;id&quot;:&quot;rating&quot;,&quot;url&quot;:&quot;https://theordinary.com/on/demandware.store/Sites-deciem-us-Site/en_US/Search-UpdateGrid?cgid=theordinary-toners&amp;prefn1=availableCountries&amp;prefv1=US&amp;srule=rating&amp;start=0&amp;sz=4&quot;}],&quot;ruleId&quot;:&quot;top-sellers-collections-suppressed&quot;}"
                                    data-page-size="12.0" data-page-number="0">



                                    <input type="hidden" class="permalink"
                                        value="https://theordinary.com/en-us/category/skincare/toners?prefn1=availableCountries&amp;prefv1=US&amp;start=0&amp;sz=12">

                                    <input type="hidden" class="category-id" value="theordinary-toners">
...
and then makes a call to render the configured template with the returned recommended products: ================= -->
                            ...
                            <script>
                                (function () {
                                    ...
                                    if (isCQ || isDC) {
                                        ...
                                        var separator = '|||';
                                        var slotConfigurationUUID = '810c184ff08f57916ec6014e8c';
                                        var contextAUID = decodeHtml('theordinary-toners');
                                        ...
                                        var slotConfigId = decodeHtml('recently-viewed-toners-plp');
                            ...
                            <div id="cq_recomm_slot-810c184ff08f57916ec6014e8c"></div>
                            <!-- ====================== snippet ends here ======================== -->
                                        ...
                                        <div class="primary-item">
                                            <div class="image">
                                                <img class="lazy"
                                                    ...
                                                    data-src="/assets/images/noc-anasayfa-1.jpg/">
                                            </div>
                                            ...
                                            <div class="secondary-item">
                                                <div class="image">
                                                    <img class="lazy"
                                                        ...
                                                        data-src="/assets/images/noc-anasayfa-2.jpg/">
                                                </div>
                                                <div class="content-copy">
                                                    <p class="content-copy_subtitle">
                                                        Cilt Bakımı Eğitimi </p>
                                            ...
                                            <div class="secondary-item">
                                                <div class="image">
                                                    <img class="lazy"
                                                        ...
                                                        data-src="/assets/images/noc-anasayfa-3.jpg/">
                                                </div>
                                                <div class="content-copy">
                                                    <p class="content-copy_subtitle">
                                                        Cilt Bakımı Eğitimi </p>
                                            ...
                                            <div class="secondary-item">
                                                <div class="image">
                                                    <img class="lazy"
                                                        ...
                                                        data-src="/assets/images/noc-anasayfa-4.jpg/">
                                                </div>
                                                <div class="content-copy">
                                                    <p class="content-copy_subtitle">
                                                        Cilt Bakımı Eğitimi </p>

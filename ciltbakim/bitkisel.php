...
$slug = 'bitkisel-biyoteknolojik-ekstraktlar';
...
// Fetch Page Sections
$pageIdentifier = 'bitkisel-biyoteknolojik-ekstraktlar';
...
<head>
    ...
    <title>
        Bitkisel & Biyoteknolojik Ekstraktlar | Noc
    </title>
...
<body data-brand="theordinary">
    ...
    <div class="page js-page" data-action="Search-Show" data-querystring="cgid=theordinary-facialcleansers"
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Bitkisel & Biyoteknolojik Ekstraktlar</span>
            ...
            <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'ciltbakim-bitkisel'); ?>
        ...
        ">
                    ...
                    $contentBlocks = getPageContentBlocks($pdo, 'bitkisel');

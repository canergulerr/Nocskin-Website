...
$slug = 'yorgun-mat-ciltler-icin-bakim';
$stmt = $pdo->prepare("SELECT * FROM categories WHERE slug = ?");
$stmt->execute([$slug]);
$category = $stmt->fetch(PDO::FETCH_ASSOC);

if (!$category) {
    $category = ['id' => 17, 'slug' => $slug];
}
...
// Fetch Page Sections
$pageIdentifier = 'yorgun-mat-ciltler-icin-bakim';
...
<head>
    ...
    <title>
        Yorgun & Mat Ciltler İçin Bakım | Noc
    </title>
...
<body data-brand="theordinary">
    ...
    <div class="page js-page" data-action="Search-Show" data-querystring="cgid=theordinary-facialcleansers"
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Yorgun & Mat Ciltler İçin Bakım</span>
            ...
            <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'ciltbakim-yorgun-mat-ciltler'); ?>
        ...
        ">
                    ...
                    $contentBlocks = getPageContentBlocks($pdo, 'yorgun-mat-ciltler');

...
$slug = 'sebum-dengeleme-akne-egilimli-ciltler';
$stmt = $pdo->prepare("SELECT * FROM categories WHERE slug = ?");
$stmt->execute([$slug]);
$category = $stmt->fetch(PDO::FETCH_ASSOC);

if (!$category) {
    $category = ['id' => 12, 'slug' => $slug];
}
...
// Fetch Page Sections
$pageIdentifier = 'sebum-dengeleme-akne-egilimli-ciltler';
...
<head>
    ...
    <title>
        Sebum Dengeleme & Akne Eğilimli Ciltler | Noc
    </title>
...
<body data-brand="theordinary">
    ...
    <div class="page js-page" data-action="Search-Show" data-querystring="cgid=theordinary-facialcleansers"
        ...
        <div role="main" id="maincontent">
            ...
            <div class="plp_breadcrumb_panel d-sm-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">
                        ...
                        <span class="breadcrumb--current js-last-breadcrumbs">Sebum Dengeleme & Akne Eğilimli Ciltler</span>
            ...
            <div class="plp-search-section">
                ...
                <div class="plp_promotions_slot">
                    ...
                    <?php render_banner($pdo, 'ciltbakim-sebum-dengeleme'); ?>
        ...
        ">
                    ...
                    $contentBlocks = getPageContentBlocks($pdo, 'sebum-dengeleme');
